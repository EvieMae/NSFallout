ITEM.name = "Revolving Carbine"
ITEM.desc = "A hybrid between a revolver and a rifle, chambered in .38. A common rifle kept by locals to fend off critters."
ITEM.model = "models/bf1/weapons/pieper m1893 revolving carbine.mdl"
ITEM.width = 4
ITEM.height = 2
ITEM.iconCam = {
