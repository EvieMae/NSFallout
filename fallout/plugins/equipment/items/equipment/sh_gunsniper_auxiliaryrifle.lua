ITEM.name = "Auxiliary Rifle"
ITEM.desc = "A powerful single-shot rifle, mass produced for the Auxiliary as a stand-in rifle. Chambered in .308, it is best used for firing lines."
ITEM.model = "models/weapons/w_preww1_trapdoor1873.mdl"
ITEM.width = 4
ITEM.height = 2
ITEM.iconCam = {
