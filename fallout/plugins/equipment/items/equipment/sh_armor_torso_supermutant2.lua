ITEM.name = "Reinforced Leather Armor XXXL"
ITEM.desc = "Leather armor, worn by mercenaries and bounty hunters. Helps slow down a bullet or absorb the impact of a swing. Upsized for a Super Mutant."
