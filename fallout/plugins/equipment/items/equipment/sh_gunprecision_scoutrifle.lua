...
ITEM.desc = "A lightweight and simplistic rifle, chambered in .38. It comes with a simplistic scope for hunting."
ITEM.model = "models/bf1/weapons/remington model 8 (35).mdl"
ITEM.width = 4
ITEM.height = 2
ITEM.iconCam = {
	pos = Vector(-200, 1, 2),
